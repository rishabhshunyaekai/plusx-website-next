...
import Icon1                from "@/assets/images/ev-charger-installation-page/product-page/plusx_electric_compatible.svg";
import Icon2                from "@/assets/images/ev-charger-installation-page/product-page/plusx_electric_output_power.svg";
import Icon3                from "@/assets/images/ev-charger-installation-page/product-page/plusx_electric_warranty.svg";
      ...
      <div className={`container ${styles.container}`}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className={styles.productImage}>
            <Image src={product.image} alt="Product" width={470} height={470} />
          </div>
          ...
          <Animated className={`${styles.productText}`} animation="fade" easing="ease-in" duration={1000}>
            ...
            {type === "chargers" && (
              <div className={styles.features}>
                <div className={styles.featureCard}><h6>Compatible</h6><p>{product.compatible}</p><Image src={Icon1} alt="Compatible" width={20} height={20} /></div>
                <div className={styles.featureCard}><h6>Output Power</h6><p>{product.output}<br /></p><Image src={Icon2} alt="Output Power" width={20} height={20} /></div>
                <div className={styles.featureCard}><h6>Warranty</h6><p>{product.warrenty}</p><Image src={Icon3} alt="Warranty" width={20} height={20} /></div>
              </div>
            )}
