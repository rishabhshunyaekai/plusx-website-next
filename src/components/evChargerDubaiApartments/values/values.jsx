          ...
          {valuesCardData.map((value, index) => {
            ...
            return (
              <div className={isLastOdd ? "lg:col-span-2" : ""} key={index}>
                <ServiceIconCard iconSrc={value.icon} heading={value.heading} text={value.text} alt={value.alt} />
              </div>
            );
