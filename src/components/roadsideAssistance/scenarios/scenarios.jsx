        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Animated className={`${style.scenariosContent} order-2 lg:order-1`} animation="fade" easing="ease-in" duration={1000}>
              ...
              <p className={style.scenariosFooter}>
                Our mobile EV rescue unit delivers up to 10 kWh of on-site EV charging directly into your vehicle — roughly 50 km of range, enough to reach home or the <Link href="/public-ev-charging-stations" target="__blank">nearest public charger</Link>. If your 12V battery is dead (and about half of all electric car breakdowns in Dubai trace back to the 12V, not the main pack), we&apos;ll jump-start it on the spot. No tow truck. No long wait. No damaged drivetrain. Just a team that actually knows EVs.
              </p>
