...
const introData = [
  {
    ...
    content           : `Stuck on Sheikh Zayed Road with a dead battery? Parked in Marina and your EV won't start? We'll reach you within 60 minutes*, depending\n on your location, and in most cases, you won't need a tow, we charge your EV on the spot. At <a href="https://plusxelectric.com/" target="__blank">PlusX Electric</a>, we've rescued more than \n575+ electric vehicles across Dubai, and we've learned one thing, traditional breakdown services aren't built for EVs. They arrive with\n a tow truck when all you really need is a charge. Our team comes with a <a href="https://plusxelectric.com/mobile-ev-charging-dubai" target="__blank">mobile charging Van</a>, gives your battery enough power \nto reach the nearest station, and gets you moving again, starting from <b>AED 145 + VAT*</b>. Whether you're driving a Tesla, BYD,\n BMW, Mercedes EQ, or any other electric model, we've got it covered. We serve every area of Dubai, from Downtown and \nBusiness Bay to Palm Jumeirah and beyond — 24 hours a day, 7 days a week. Book instantly through the \nPlusX Electric app, or call us on <a href="tel:+971543061473">+971 54 306 1473</a> if you're already stranded.`,
