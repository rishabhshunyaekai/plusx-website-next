import style from "./privacyPolicies.module.css";

function PrivacyPolicy() {
  return (
    <div className={`container ${style.wrapperPP}`}>
      <h1 className={style.mainHeadingPP}>Privacy Policy</h1>
      <p className={style.content}>
        This privacy policy applies to the PlusX Electric App (hereby referred
        to as &quot;Application&quot;) for mobile devices that was created by
        Shunya Ekai Technologies (hereby referred to as &quot;Service
      ...
      <p className={style.content}>
        ...
        media@plusxelectric.com The information that the Service Provider
        requests will be retained by them and used as described in this privacy
        policy.
      </p>

      <h4 className={style.subHeadingPP}>Third Party Access</h4>
      <p className={style.content}>
      ...
      <h4 className={style.subHeadingPP}>Opt-Out Rights</h4>
      <p className={style.content}>
      ...
      <h4 className={style.subHeadingPP}>Data Retention Policy</h4>
      <p className={style.content}>
        ...
        <a href="mailto:media@plusxelectric.com" className={style.emailLink}>
          media@plusxelectric.com
        </a>{" "}
        and they will respond in a reasonable time.
      </p>

      <h4 className={style.subHeadingPP}>Children</h4>
      <p className={style.content}>
      ...
      <h4 className={style.subHeadingPP}>Security</h4>
      <p className={style.content}>
      ...
      <h4 className={style.subHeadingPP}>Changes</h4>
      <p className={style.content}>
      ...
      <p className={style.content}>
        This privacy policy is effective as of 2026-01-15.
      </p>

      <h4 className={style.subHeadingPP}>Your Consent</h4>
      <p className={style.content}>
      ...
      <h4 className={style.subHeadingPP}>Contact Us</h4>
      <p className={style.content}>
