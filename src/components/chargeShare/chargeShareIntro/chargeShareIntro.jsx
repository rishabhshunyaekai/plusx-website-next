...
const introData = [
  {
    ...
    secondaryContent    : `<strong>Private EV charger sharing</strong> means that people who already have a home charger can share it with other \nEV owners at specific time intervals.`,
