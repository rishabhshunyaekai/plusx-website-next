...
const introData = [
  {
    ...
    secondaryContent    : `Private <a href="/ev-charger-installation-uae" target="__blank">EV charger</a> sharing is a community feature inside the PlusX Electric app that lets EV owners with a private charger \nmake it available to fellow EV owners during the times they're not using it themselves.`,
