...
const FAQ = () => {
    ...
    const faqSection = {
        ...
        "mainEntity": [
            {
                "@type" : "Question",
                "name"  : "Can someone come and charge my EV on the road in Dubai if my battery is drained?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "Who to call if my EV runs out of charge in Dubai?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "How long does it take for roadside EV charging to arrive?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "How to avoid EV battery draining in hot weather in Dubai?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "Are there any companies that provide jump start service?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "Who should I call if my electric car stops in Dubai- roadside assistance or towing?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "How much driving range does an emergency EV charging service provide in Dubai?",
                "acceptedAnswer": {
                    "@type" : "Answer",
