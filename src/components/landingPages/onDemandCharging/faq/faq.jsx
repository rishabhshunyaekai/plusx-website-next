...
const FAQ = () => {
    ...
    const faqSection = {
        ...
        "mainEntity": [
            {
                "@type" : "Question",
                "name"  : "My EV battery is low – can someone come charge my car?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "What if my EV is parked in a basement or closed parking area?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@type" : "Answer",
                    "text"  : "Starting from AED 109 + VAT for fast, reliable, doorstep EV charging anywhere in Dubai."
                }
            },
            {
                "@type" : "Question",
                "name"  : "Is range anxiety a real problem for EV owners?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "How can a user avoid range anxiety while driving an EV?",
                "acceptedAnswer": {
                    "@type" : "Answer",
            ...
            {
                "@type" : "Question",
                "name"  : "Is on-demand EV charging more expensive than using a public station?",
                "acceptedAnswer": {
                    "@type" : "Answer",
