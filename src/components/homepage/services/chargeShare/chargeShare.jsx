      ...
      <div className={`container`}>
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-15 lg:gap-15`}>
          <div className={`lg:col-span-1`}>
            <Animated className={style.cardContainer} animation="fade" easing="ease-in" duration={1000}>
              <h2 className={style.cardTitle}>
                <Link href="/public-ev-charging-stations">Public EV <br className={style.breakLine} /> Charging Stations</Link>
              </h2>
              ...
              <div className={style.cardImageWrapper}>
                <Image className={style.cardImage} src={Charging} alt="PlusX Electric public charging service in Dubai" width={405} height={370} />
              </div>
            </Animated>
          </div>
          ...
          <div className={`lg:col-span-1`}>
            <Animated className={style.cardContainer} animation="fade" easing="ease-in" duration={1000}>
              <h2 className={style.cardTitle}>
                <Link href="/complete-ev-care-dubai">EV Car <br className={style.breakLine} /> Detailing Service</Link>
              </h2>
              ...
              <div className={style.cardImageWrapper}>
                <Image className={style.cardImage} src={Share} alt="PlusX Electric EV car detailing service in Dubai" width={405} height={370} />
              </div>
            </Animated>
          </div>
