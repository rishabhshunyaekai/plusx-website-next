        ...
        <div className={`grid grid-cols-1 lg:grid-cols-3 items-center`}>
          <div className={`lg:col-span-1 order-2 lg:order-1`}>
            <div className={style.cardImageWrapper}>
              <Image className={style.cardImage} src={Share} alt="PlusX Electric EV Charge Share service in Dubai" width={405} height={408} />
            </div>
          </div>
          <div className={`lg:col-span-2 order-1 lg:order-2`}>
            <Animated className={style.contentWrapper} animation="slide-left" easing="ease-in" duration={1000}>
              <h2 className={style.cardTitle}>
                <Link href="/ev-charge-share">EV Charge Share</Link>
              </h2>
