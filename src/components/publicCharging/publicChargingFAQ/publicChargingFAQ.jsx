...
function PublicChargingFaqs() {
  ...
  const publicCharging = {
    ...
    "mainEntity": [
        {
            "@type" : "Question",
            "name"  : "What if the charger I go to is occupied?",
            "acceptedAnswer": {
                "@type" : "Answer",
        ...
        {
            "@type" : "Question",
            "name"  : "How do I avoid driving around for chargers?",
            "acceptedAnswer": {
            "@type" : "Answer",
        ...
        {
            "@type" : "Question",
            "name"  : "What if I am running low on battery?",
            "acceptedAnswer": {
            "@type" : "Answer",
        ...
        {
            "@type" : "Question",
            "name"  : "How do I find chargers during long drives?",
            "acceptedAnswer": {
            "@type" : "Answer",
        ...
        {
            "@type" : "Question",
            "name"  : "Is there an app to find public EV charging stations in real time?",
            "acceptedAnswer": {
            "@type" : "Answer",
        ...
        {
            "@type" : "Question",
            "name"  : "Can I find charging stations between Dubai and Abu Dhabi?",
            "acceptedAnswer": {
            "@type" : "Answer",
