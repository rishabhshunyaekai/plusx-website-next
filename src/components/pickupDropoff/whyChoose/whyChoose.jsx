...
import Plusx    from "@/assets/images/pickup-dropoff-page/Plusx_electric_why_choose_ev_pickup_dropoff_service_image.webp";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-4">
          ...
          <Animated className={style.rightContent} animation="fade" easing="ease-in" duration={1000}>
            ...
            <ul className={style.keyPoint}>
              ...
              <li>Your vehicle is returned to your location in approximately 2 hours.</li>
