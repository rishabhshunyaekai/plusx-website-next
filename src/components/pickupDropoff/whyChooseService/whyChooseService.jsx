...
import image    from "@/assets/images/pickup-dropoff-page/Plusx_electric_why_ev_owner_choose_pickup_service_image.webp";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Animated className="order-1 lg:order-2" animation="fade" easing="ease-in" duration={1000}>
              <div className={style.imageWrapper}>
                <Image src={image} alt="EV pickup service helping Dubai EV owners save time" width={555} height={555} />
              </div>
            </Animated>
