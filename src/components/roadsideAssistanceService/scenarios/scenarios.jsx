      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Animated className={`${style.scenariosContent} order-2 lg:order-1`} animation="fade" easing="ease-in" duration={1000}>
              ...
              <p className={style.scenariosIntro}>A petrol car runs out of fuel — you grab a jerry can, problem solved. An electric car is different. Traditional EV roadside assistance in Dubai usually defaults to towing, which is slow, expensive, and often unnecessary. Worse, most tow operators aren&apos;t trained for EVs, and improper towing (dragging with wheels on the ground) can force the electric motor to spin, generating current that damages the drivetrain. Some manufacturers explicitly state that this voids the warranty.</p>
              <h3 className={style.scenariosIntro}><strong>Our approach is simpler: we bring the charge to you</strong></h3>
              <p className={style.scenariosFooter}>
                Our mobile EV rescue unit delivers up to 10 kWh of on-site EV charging directly into your vehicle — roughly 50 to 70 km of range, enough to reach home or the <Link href="/public-ev-charging-stations">nearest public charger</Link>. If your 12V battery is dead (and about half of all electric car breakdowns in Dubai trace back to the 12V, not the main pack), we&apos;ll jump-start it on the spot. No tow truck. No long wait. No damaged drivetrain. Just a team that actually knows EVs.
              </p>
            ...
            <Animated className="order-1 lg:order-2" animation="fade" easing="ease-in" duration={1000}>
              <div className={style.imageWrapper}>
                <Image src={image} alt="PlusX Electric EV roadside assistance Dubai — mobile van charging an electric vehicle on site" width={555} height={555} />
              </div>
            </Animated>
