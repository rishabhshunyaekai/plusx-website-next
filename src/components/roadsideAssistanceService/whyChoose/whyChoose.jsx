        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-4">
          ...
          <Animated className={style.rightContent} animation="fade" easing="ease-in" duration={1000}>
            ...
            <ul className={style.keyPoint}>
              ...
              <li><b>Instant Booking Through the App —</b>  The PlusX Electric app is trusted by 6800+ EV drivers in the UAE. Book a rescue in under 60 seconds. <i>Transparent Pricing — From AED 145 + VAT*</i> — No hidden fees. Your confirmed quote is shown in the app before dispatch.</li>
