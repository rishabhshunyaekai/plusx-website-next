        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-4">
          ...
          <Animated className={style.rightContent} animation="fade" easing="ease-in" duration={1000}>
            ...
            <ul className={style.keyPoint}>
              ...
              <li><b>575+ EVs Rescued Across Dubai —</b> Real experience with real breakdowns, not theoretical training. We&apos;ve handled dead batteries on Sheikh Zayed Road, 12V failures in JLT building parking, and stuck charge connectors in Palm Jumeirah villas.</li>
              <li><b>60-Minute Response Time —</b> Depending on your location, our average dispatch-to-arrival time across 575+ rescues is under 60 minutes.</li>
              ...
              <li><b>Instant Booking Through the App —</b>  The PlusX Electric app is trusted by 5,000+ EV drivers in the UAE. Book a rescue in under 60 seconds. <i>Transparent Pricing — From AED 145 + VAT*</i> — No hidden fees. Your confirmed quote is shown in the app before dispatch.</li>
