...
export const mobileRescue = [
  ...
  },
  {
    ...
    items: [
      ...
      `The cost is transparent and known up front (service starts from AED 145 + VAT), unlike a tow charge that may show up on your final bill as an opaque "recovery fee."`,
    ],
  ...
  {
    type: "paragraph",
    text: "It's not the answer when there's an actual mechanical or accident-related issue. Collision damage, suspension failure, a flat tyre, a blown coolant line — those need a tow to a workshop and a proper diagnostic. The PlusX Electric team will tell you honestly if your situation needs a tow rather than a charge; they've handled 575+ rescues and know the difference."
  },
  {
    type: "paragraph",
