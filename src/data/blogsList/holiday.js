...
export const holiday = [
  {
    type: "paragraph",
    text: `Holidays are a time to wrap up your work, spend time with loved ones, and take a break from everyday obligations. Long holiday vacations, however, also mean that owners of electric vehicles must leave their vehicles parked and unused for extended periods. Without proper preparation, this inactivity can lead to battery drain, reduced efficiency, or inconvenience once you return.`,
  },
  {
    type: "paragraph",
  ...
  {
    type: "paragraph",
    text: `The good news is that taking a few basic precautions makes EV maintenance during the holidays simple and manageable. Here is everything you need to know:`,
  },
  {
    type: "heading",
    level: 2,
    text: "How an Idle EV Is Affected by Holidays"
  },
  {
    type: "ul",
    items: [
      "When an electric vehicle is parked for several days or weeks, certain changes naturally occur. You can better prepare if you are aware of these.",
      "EV batteries slowly lose charge even when the vehicle is switched off due to background systems.",
      "Extended inactivity can lead to lower battery levels than expected and may affect long-term efficiency.",
      "Security features and internal monitoring continue to consume small amounts of power.",
      "Tyres may lose air pressure, and initial driving performance can feel slightly different after long parking periods.",
      "Without proper preparation, an idle EV may face unexpected battery depletion or delayed readiness after holidays.",
    ],
  },
  {
    type: "heading",
