...
export const trustPlusx = [
  ...
  },
  {
    ...
    type: "ul",
    items: [
      "1000+ EVs rescued from breakdowns caused by low or zero charge",
    ...
    schemas : [
      {
        ...
        "description" : "EV breakdown Dubai due to low charge? PlusX Electric has rescued 1000+ EVs with an 87% success rate, offering on-site charging, jump start and 12V support for stranded EV drivers.",
